...
export class CourseService {
    ...
    retrieveAll(): Observable<Course[]> {
        //return COURSES;   //  antigo return sem o REST
        return this.httpClient.get<Course[]>(this.courseUrl);
    }

    //  Method retrieveById
    retrieveById(id: number): Observable<Course> {
        //return COURSES.find((courseIterator: Course) => courseIterator.id === id) as Course;  //  antigo return sem o REST
...
/*
//  Não é mais preciso, pos agora é obtido por REST
var COURSES: Course[] = [
    {
        id: 1,
        name: 'Angular: CLI',
